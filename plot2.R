# plot2.R
# This routine loads the data file "household_power_consumption.txt" and plots global active power vs time.
# Data for the dates 01/01/2007 through 02/02/2007 are extracted. 
# Coursera "Exploratory Data Analysis", Assignment 1, plot 2, course 009, Nov 2014
# The result is saved as plot2.png
...
png("plot2.png")
plot(NEWhpcdates$DateTime,NEWhpcdates$Global_active_power, type = "l",lty = 1, xlab = "", ylab = "Global Active Power (kilowatts)")
